...
for i in range(len(members)):
  ...
  for j in range(len(fhours1)):
    if i==0:
      ...
      grbind = pygrib.index('/home/gefs/gefs/model_data/gefs/gefs.'+str(ymd)+'/'+str(hour).zfill(2)+'/atmos/pgrb2bp5/ge'+members[i]+'.t'+str(hour).zfill(2)+'z.pgrb2b.0p50.f'+str(fhours1[j]).zfill(3),'name','level')
      #for grb in grbs:
      if j==0:
